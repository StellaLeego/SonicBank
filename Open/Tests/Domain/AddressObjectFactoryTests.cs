    ...
    [TestClass] public class AddressObjectFactoryTests : BaseTests {
        ...
        public void CreateDeviceTest() {
            ...
            var o = AddressObjectFactory.CreateDevice(
                r.ID, r.RegionOrStateOrCountryCode, r.CityOrAreaCode, r.Address, r.ZipOrPostCodeOrExtension,
                r.NationalDirectDialingPrefix, r.Device, r.ValidFrom, r.ValidTo);
            Assert.IsInstanceOfType(o, typeof(TelecomAddressObject));
            testVariables(o.DbRecord, r.ID, r.Address,r.ValidFrom,r.ValidTo, r.CityOrAreaCode,r.RegionOrStateOrCountryCode,o.DbRecord.ZipOrPostCodeOrExtension);
        ...
        public void CreateAddressTest() {
            ...
            var o = AddressObjectFactory.CreateAddress(
                r.ID, r.Address, r.CityOrAreaCode, r.RegionOrStateOrCountryCode, r.ZipOrPostCodeOrExtension,
                r.CountryID, r.ValidFrom, r.ValidTo);
