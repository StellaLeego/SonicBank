...
namespace Open.Facade.Project {
    public abstract class PaymentViewModel : UniqueEntityViewModel {
        ...
        [StringLength(30, MinimumLength = 4,
            ErrorMessage = "Name cant be less than 4 characters and longer than 30 characters")]
        [DisplayName("Payer")]
        public string Payer {
        ...
        [StringLength(30, MinimumLength = 1,
            ErrorMessage = "Memo cant be less than 1 characters and longer than 30 characters")]
        [DisplayName("Memo")]
        public string Memo {
